...
@Component({
  selector: 'app-userpassdatacomponet',
  imports: [],
  templateUrl: './userpassdatacomponet.component.html',
  styleUrl: './userpassdatacomponet.component.css'
})
export class UserpassdatacomponetComponent {
